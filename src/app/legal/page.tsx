...
export const metadata = { title: "Legal | Part Passport" };
...
export default function LegalHub() {
  return (
    <main className="mx-auto max-w-2xl space-y-5 px-4 py-10">
      ...
      <Card className="border-amber-700"><p className="text-sm text-amber-200">Part Passport provides cryptographic record integrity and does not certify airworthiness. It is not an FAA or EASA approved document, and it does not replace required inspections or approvals.</p></Card>
