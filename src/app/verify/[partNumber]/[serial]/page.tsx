...
export default async function VerifyPage({ params }: { params: Promise<{ partNumber: string; serial: string }> }) {
 ...
 <div className="rounded-[4px] border border-[#9F1239] bg-[#1A0A10] p-5 text-red-200 ">
 ...
 <li key={flag.id} className="border-t border-[#9F1239] pt-2 first:border-0 first:pt-0">
